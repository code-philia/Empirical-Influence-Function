...
def parse_args():
    ...
    parser.add_argument('--tokenizer_path', '-tokenizer_path', type=str, default="Qwen/Qwen2.5-Coder-1.5B-Instruct", help='Path to tokenizer')
    parser.add_argument('--save_format', '-save_format', type=str, default=".jsonl", help='Path to tokenizer')
...
if __name__ == "__main__":
    ...
    tokenize_file(workers=args.workers,
